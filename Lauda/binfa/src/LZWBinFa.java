...
public class LZWBinFa {
	 ...
	 * az épülő LZW-fánk azon csomópontjára mutat, amit az input feldolgozása során
	 ...
	 * a hallgató érdeklődését, mert ekkor így nyomhatjuk a fába az inputot: binFa
	 * << b; ahol a b egy '0' vagy '1'-es betű. Mivel tagfüggvény, így van rá
	 * "értelmezve" az aktuális (this "rejtett paraméterként" kapott ) példány, azaz
	 * annak a fának amibe éppen be akarjuk nyomni a b betűt a tagjai (pl.: "fa",
	...
	public void egyBitFeldolg(char b) {
		...
		if (b == '0') {
			/*
			 * Van '0'-s gyermeke az aktuális csomópontnak? megkérdezzük Tőle, a "fa" mutató
			 * éppen reá mutat
			 */
			/*
			 * if (!fa->nullasGyermek ()) // ha nincs, hát akkor csinálunk { // elkészítjük,
			 * azaz páldányosítunk a '0' betű akt. parammal Csomopont *uj = new Csomopont
	 ...
	 * stb.) rekurzívak, tk. a rekurzív fabejárást valósítják meg (lásd a 3. előadás
	 * "Fabejárás" c. fóliáját és társait)
	 * 
	 * (Ha a rekurzív függvénnyel általában gondod van => K&R könyv megfelelő része:
	...
	public void kiir() throws FileNotFoundException {
		...
		// ugye ha most két helyről hívják meg az objektum ilyen függvényeit, tahát ha
	 ...
	 * minősítve definiálni :) l. lentebb
	 */
	/*
	 ...
	 * namespace std-t elvből nem használjuk bevezető kurzusban, így ez a
	 * konstrukció csak az argfüggő névfeloldás miatt fordul le (B&L könyv 185. o.
	...
	class Csomopont {
		...
		// közvetlenül
		// a Csomopont tagjaival dolgoznak, hanem beállító/lekérdező üzenetekkel érik el
		// azokat */
	...
	// ... :)
	// Nem erőltetjük viszont a külön fájlba szedést, mert a sablonosztályosított
	// tovább
	...
	/*
	 * Ez volt eddig a main, de most komplexebb kell, mert explicite bejövő, kimenő
	 ...
	 * mivel nekünk sokkal egyszerűbb is elég, alig hagyunk meg belőle valamit...
	 */
	/*
	...
	public static void main(String args[]) {
		 ...
		 * erről a júzetr: usage (); // és jelezzük az operációs rendszer felé, hogy
		...
		try {
			 ...
			 *
			 * // egyszerűen a korábbi d.c kódját bemásoljuk // laboron többször lerajzoltuk
			 * ezt a bit-tologatást: // a b-ben lévő bájt bitjeit egyenként megnézzük for
			 * (int i = 0; i < 8; ++i) { // maszkolunk eddig..., most már simán írjuk az if
			 * fejébe a legmagasabb helyiértékű bit vizsgálatát // csupa 0 lesz benne a
			 * végén pedig a vizsgált 0 vagy 1, az if megmondja melyik: if (b & 0x80) // ha
			 * a vizsgált bit 1, akkor az '1' betűt nyomjuk az LZW fa objektumunkba binFa <<
			 * '1'; else // különben meg a '0' betűt: binFa << '0'; b <<= 1; }
			 *
			 * }
			 */
			while (beFile.read(b) != -1) {
