...
int main(int argc, char *argv[])
{
	...
	std::string defops = "City/Debrecen/Oktatás/Informatika/Programozás/DEIK/Prog1/Példák/Elõadás;City/Debrecen/Szórakozás/Könyv/Ismeretterjesztõ/Informatika;City/Debrecen/Oktatás/Informatika/Programozás/Tankönyv\ olvasás";
	...
	desc.add_options()
		...
		("root", boost::program_options::value< std::string >()->default_value(defops),
			" the name of a subdirectory of the FUTURE activity tree to be processed by this program. The default value is City/Debrecen/Oktatás/Informatika/Programozás/DEIK/Prog1/Példák/Elõadás")
		;
